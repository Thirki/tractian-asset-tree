import { useSelectStatusColor, statusType } from "../../hooks";
import React from "react";

interface IEnergyIconProps {
  width?: number;
  height?: number;
...
export const EnergyIcon: React.FC<IEnergyIconProps> = ({
  width = 14,
  height = 16,
  iconStatus = "loading",
  customColor,
}) => {
  const statusColor = useSelectStatusColor(iconStatus);
  return (
    <svg
      width={width}
      height={height}
